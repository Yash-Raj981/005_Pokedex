...
It's a wikipedia kind of page which contains information of all pokemons. I used to play and watch Pokemon games & series respectively, so i made this.
...
```
git clone https://github.com/Yash-Raj981/005_Pokedex.git
```
